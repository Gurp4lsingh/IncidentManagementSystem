/*
  ...
  Provides validation functions for incident data and status transitions.
  Uses configuration from config.js for validation rules.
 */

import { config } from "../../config.js"

// Export categories and severities for use in other modules
